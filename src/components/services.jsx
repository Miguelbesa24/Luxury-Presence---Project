...
const Services = () => {
    ...
    <div>
      <nav id="navbar" className="fixed top-0 w-full z-10 bg-transparent px-10 pt-12">
        <div className="flex justify-between items-center text-gray-100 font-sans font-bold text-xs pb-4">
          <div>
            <img src={Logo} alt="Logo" className="w-18 h-3" />
          </div>
  ...
  <div className='text-5xl font-serif flex justify-center'>
    Comprehensive Marketing Plan
  </div>
  <div className='py-20 px-20'>
  <div className='flex justify-center py-6'>
    <img src={desktop} alt="Desktop view" className="w-3/4" />
  </div>
  
  <div className='flex flex-row justify-between items-center text-center ml-10 pr-10'>
    <div>
  ...
  <div className='flex flex-row justify-between items-center text-center ml-10 pr-10 mt-12'>
    <div>
